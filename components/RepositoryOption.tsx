...
import { Repository } from './CoreFunction'

type RepositoryOptionProps = {
  repository: Repository;
};

export function RepositoryOption({ repository }: RepositoryOptionProps) {
  return (
    <Combobox.Option
        ...
        <>
          <header className="flex items-center">
            <CpuChipIcon
              ...
              aria-hidden="true"
            />
            <span className="ml-1 font-bold flex-auto truncate">{repository.name}</span>
          </header>
